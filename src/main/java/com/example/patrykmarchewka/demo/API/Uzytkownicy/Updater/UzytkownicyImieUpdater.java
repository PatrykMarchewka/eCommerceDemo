...
public class UzytkownicyImieUpdater implements UzytkownicyCREATEUpdater,UzytkownicyPUTUpdater,UzytkownicyPATCHUpdater{
    @Override
    ...
    void sharedUpdate(Uzytkownicy uzytkownik, UzytkownicyRequestBody body){
        uzytkownik.setImie(body.getImie());
    }
}
