...
public class AdresyNumerMieszkaniaUpdater implements AdresyCREATEUpdater,AdresyPUTUpdater,AdresyPATCHUpdater{
    @Override
    ...
    public void PATCHUpdate(Adresy adres, AdresyRequestBody body) {
        if (body.getNumerMieszkania() != null){
            sharedUpdate(adres, body);
        }
    }
    ...
    void sharedUpdate(Adresy adres, AdresyRequestBody body){
        adres.setNumerMieszkania(body.getNumerMieszkania());
    }
}
