...
public class ProduktyNazwaUpdater implements ProduktyCREATEUpdater,ProduktyPUTUpdater,ProduktyPATCHUpdater{
    @Override
    ...
    void sharedUpdate(Produkty produkt, ProduktyRequestBody body){
        produkt.setNazwa(body.getNazwa());
    }
}
