...
public class AdresyMiastoUpdater implements AdresyCREATEUpdater,AdresyPUTUpdater,AdresyPATCHUpdater{
    @Override
    ...
    void sharedUpdate(Adresy adres, AdresyRequestBody body){
        adres.setMiasto(body.getMiasto());
    }
}
