...
public class UzytkownicyTelefonUpdater implements UzytkownicyCREATEUpdater,UzytkownicyPUTUpdater,UzytkownicyPATCHUpdater{
    @Override
    ...
    void sharedUpdate(Uzytkownicy uzytkownik, UzytkownicyRequestBody body){
        uzytkownik.setTelefon(body.getTelefon());
    }
}
