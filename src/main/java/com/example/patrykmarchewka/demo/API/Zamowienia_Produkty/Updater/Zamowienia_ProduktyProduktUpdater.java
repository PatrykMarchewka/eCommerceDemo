...
public class Zamowienia_ProduktyProduktUpdater implements Zamowienia_ProduktyCREATEUpdater,Zamowienia_ProduktyPUTUpdater,Zamowienia_ProduktyPATCHUpdater{


    private final ProduktyService produktyService;
    public Zamowienia_ProduktyProduktUpdater(ProduktyService produktyService){
    ...
    void sharedUpdate(Zamowienia_Produkty zamowieniaProdukty, Zamowienia_ProduktyRequestBody body){
        zamowieniaProdukty.setProdukt(produktyService.getProduktByID(body.getProduktyID()));
    }
}
