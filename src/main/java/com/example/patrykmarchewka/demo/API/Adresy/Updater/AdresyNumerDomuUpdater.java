...
public class AdresyNumerDomuUpdater implements AdresyCREATEUpdater,AdresyPUTUpdater,AdresyPATCHUpdater{
    @Override
    ...
    void sharedUpdate(Adresy adres, AdresyRequestBody body){
        adres.setNumerDomu(body.getNumerDomu());
    }
}
